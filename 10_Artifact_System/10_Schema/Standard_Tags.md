...
title: "Standard_Tags — Tag System Operating Note"
type: STANDARD
status: active
trust_level: 3
...
provenance:
  ...
  git_path: "10_Artifact_System/10_Schema/Standard_Tags.md"
tags: [studio_framework, artifact_system, schema, tags, retrieval]
---

# Standard_Tags — Tag System Operating Note

**Version**: 0.2.0 | **Date**: 23.03.2026 | **Time**: 22:42 | **GlobalID**: 20260323_2242_Standard_Tags_v0

**Last Updated:** 23.03.2026 22:42  
**Framework:** Studio_Framework_Artifact_System  
**Status:** beta

**Git:** Repo: Studio_Framework | Branch: main | Path: 10_Artifact_System/10_Schema/Standard_Tags.md | Commit: pending
